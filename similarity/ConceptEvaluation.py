...
axes[1].set_xlabel('Proposed Algorithms', fontsize=12)
axes[1].set_ylabel('Rank Correlation', fontsize=12)
axes[1].set_title("Structure based Algorithms and Proposed Algorithms", fontsize=14)
axes[1].set_ylim([0,1.5])
axes[1].legend(loc='best')
frame3.plot(kind='bar',grid=False, ax=axes[1], alpha=0.7)

axes[0].set_xlabel('Structure Based Algorithms', fontsize=12)
axes[0].set_ylabel('Rank Correlation', fontsize=12)
axes[0].set_title("Structure Based Algorithms", fontsize=14)
axes[0].set_ylim([0,1.5])
axes[0].legend(loc='best')
frame4.plot(kind='bar',grid=False,ax=axes[0], alpha=0.7)
