...
class WordSimEvaluation:
    ...
    def evaluate_single_metric(self, sim_name, sim_func, dataset_name, save_results=False):
        """
    ...
    def evaluate_multiple_metrics(self, sim_dict, dataset_name):
        ...
        for sim_name, sim_func in sim_dict.iteritems():
            cor_dict[sim_name] = self.evaluate_single_metric(sim_name, sim_func, dataset_name, save_results=True)
        return cor_dict
    ...
    def evaluate_wpath_k(self, dataset_name, ic='corpus'):
        ...
        for k in range(1, 11):
            ...
            cor_dic[k] = self.evaluate_single_metric('wpath-'+ str(k), sim_func, dataset_name)
        return cor_dic
